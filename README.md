...
## Dataset
The dataset for this analysis can be downloaded [here](https://github.com/SterbenK7/AB-Test/blob/main/application.csv).
...
Please refer to the attached [slides](https://github.com/SterbenK7/AB-Test/blob/main/ds_instacart_ppt_solution_6_pages.pdf) for a summary of the findings and recommendations. The appendix contains additional content, including code snippets and workbooks used for the analysis.
